...
--
-- Name: restrictions; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.restrictions OWNER TO admin;

--
-- Name: restrictions_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER TABLE public.restrictions_id_seq OWNER TO admin;

--
-- Name: restrictions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.room_restrictions OWNER TO admin;
...
ALTER TABLE public.rooms_id_seq OWNER TO admin;
...
--
-- Name: restrictions id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Name: restrictions restrictions_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: reservations_email_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: reservations_last_name_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions_reservation_id_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions_room_id_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions_start_date_end_date_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: reservations reservations_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions room_restrictions_reservations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions room_restrictions_restrictions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions room_restrictions_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
