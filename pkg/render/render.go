...
func AddDefaultData(template_data *models.TemplateData) *models.TemplateData {
	return template_data
}

func RenderTemplates(w http.ResponseWriter, tmpl string, template_data *models.TemplateData) {
